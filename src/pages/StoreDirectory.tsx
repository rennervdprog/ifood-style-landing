...
const plans = [
  {
    ...
    borderColor: "border-emerald-200",
      description: "Apenas comissão por pedido, todas as funcionalidades. Sem mensalidade.",
    features: [
  ...
  },
  {
    ...
    borderColor: "border-blue-200",
     description: "Comece por R$ 50 — cresce junto com você. Comissão reduzida.",
    features: [
      "Tudo do plano Comissão",
      "Comissão reduzida (2,5%)",
      "PDV presencial (1% comissão)",
  ...
  },
  {
    ...
    borderColor: "border-primary/30",
     description: "Comece por R$ 90 — cresce junto com você. Zero comissão por pedido.",
    features: [
      "Tudo do plano Crescimento",
      "Zero comissão por pedido (0%)",
      "PDV presencial (R$ 1 por venda)",
      "R$ 90/mês → R$ 180 após 2 meses faturando acima de R$ 5.000",
      "Taxa PIX R$ 1,99/transação",
    ],
    extraFees: [
