...
const plans = [
  {
    ...
    description: "Ideal para quem está começando e quer testar sem risco. Pague apenas quando vender.",
    features: [
      ...
      { text: "Fidelidade", included: true },
      { text: "Relatórios básicos", included: true },
      { text: "Suporte por WhatsApp", included: true },
      { text: "Relatórios avançados", included: false },
      { text: "Destaque na vitrine", included: false },
  ...
  },
  {
    ...
    description: "Para lojas que já vendem bem e querem pagar menos comissão com mais ferramentas.",
    features: [
      { text: "Tudo do plano Comissão", included: true },
      ...
      { text: "Agendamento de pedidos", included: true },
      { text: "Suporte VIP", included: false },
      { text: "Prioridade em novidades", included: false },
    ],
    extraFees: [],
  },
  {
    ...
    description: "Zero comissão. Você fica com 100% do valor de cada pedido. Lucro máximo garantido.",
    features: [
      { text: "Tudo do plano Crescimento", included: true },
      { text: "Zero comissão por pedido", included: true },
      { text: "Suporte VIP prioritário", included: true },
      { text: "Relatórios premium", included: true },
      { text: "Prioridade em novidades", included: true },
      { text: "Todas as ferramentas", included: true },
      { text: "ROI garantido", included: true },
    ],
    extraFees: [
      { label: "Taxa PIX fixa", value: "R$ 1,00/transação" },
      { label: "Taxa entrega plataforma", value: "R$ 2,00/pedido (paga pelo cliente)" },
    ],
  },
];
