      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6 text-sm text-muted-foreground">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-4 space-y-2">
            ...
            <li><strong className="text-foreground">Autonomia (R$ 0/mês inicialmente):</strong> 0% comissão sobre pedidos delivery. Sem taxa de R$ 2,00 da plataforma na entrega — o cliente paga exatamente a taxa que o Lojista define. Taxa PIX Online: R$ 1,99/transação. PDV: R$ 1,00/venda presencial. <strong className="text-foreground">Plano dinâmico:</strong> após a loja atingir R$ 2.500 em faturamento acumulado, a mensalidade passa a R$ 239,90/mês, mediante prévia notificação e aceite expresso (vide 5.2).</li>
          ...
          <p>5.2. <strong className="text-foreground">Planos Dinâmicos (Essencial e Autonomia):</strong> O faturamento acumulado da loja é apurado automaticamente. O reajuste para o valor cheio (R$ 180/mês no Essencial após R$ 5.000 em vendas; R$ 239,90/mês no Autonomia após R$ 2.500 em vendas) ocorre apenas <strong className="text-foreground">mediante aceite expresso do Lojista no painel</strong>, com antecedência mínima de 30 dias. O Lojista pode, sem multa, (a) recusar o reajuste e migrar para outro plano disponível, ou (b) rescindir o contrato antes da entrada em vigor. Lojas cadastradas antes de 20/05/2025 mantêm os valores anteriores.</p>
        ...
        <section className="space-y-3">
          ...
          <p>9.4. Taxa de entrega (R$ 2,00): somada à taxa base definida pelo lojista, paga pelo cliente no checkout. Aplica-se aos planos Essencial e Apoiador em todos os métodos de pagamento. No plano Autonomia essa taxa da plataforma é zero.</p>
