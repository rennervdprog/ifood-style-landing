    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6 text-sm text-muted-foreground">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-4 space-y-2">
            <li><strong className="text-foreground">Essencial (R$ 0/mês inicialmente):</strong> 0% comissão sobre pedidos delivery. Taxa PIX Online: R$ 1,99/transação (descontada do repasse). Taxa de entrega: R$ 2,00/pedido (paga pelo cliente). PDV: R$ 1,00/venda presencial. <strong className="text-foreground">Plano dinâmico:</strong> após a loja atingir R$ 5.000 em faturamento acumulado, a mensalidade passa a R$ 180/mês, mediante prévia notificação e aceite expresso (vide 5.2).</li>
            <li><strong className="text-foreground">Autonomia (R$ 329,90/mês):</strong> 0% comissão sobre pedidos delivery. Sem taxa de R$ 2,00 da plataforma na entrega — o cliente paga exatamente a taxa que o Lojista define. Taxa PIX Online: R$ 1,99/transação. PDV: R$ 1,00/venda presencial. Inclui 7 dias grátis.</li>
            <li><strong className="text-foreground">Apoiador (R$ 75/mês — limitado a 10 vagas):</strong> mensalidade fixa para os primeiros 10 lojistas que aderirem, sem reajuste por inflação ou política comercial. 0% comissão. Taxas: R$ 1,99 PIX Online, R$ 2,00/entrega (paga pelo cliente), R$ 1,00/venda PDV. Reajustes só podem ocorrer em caso de (i) alteração de carga tributária que incida diretamente sobre o serviço, ou (ii) descumprimento contratual pelo Lojista. As vagas são garantidas enquanto a loja mantiver o plano ativo e adimplente.</li>
          </ul>
          <p>5.2. <strong className="text-foreground">Plano Dinâmico (Essencial):</strong> O faturamento acumulado da loja é apurado automaticamente. O reajuste para R$ 180/mês ocorre apenas após a loja atingir R$ 5.000 em vendas e <strong className="text-foreground">depende de aceite expresso do Lojista no painel</strong>, com antecedência mínima de 30 dias. O Lojista pode, sem multa, (a) recusar o reajuste e migrar para outro plano disponível, ou (b) rescindir o contrato antes da entrada em vigor. Lojas cadastradas antes de 20/05/2025 mantêm os valores anteriores.</p>
          ...
          <p>5.4. Os planos Essencial (grátis inicial) e Somente PDV podem ser utilizados imediatamente. O plano Autonomia inclui 7 dias de teste grátis.</p>
        ...
        <section className="space-y-3">
          ...
          <p>9.2. Comissão PDV percentual incide sobre o subtotal da venda presencial (6% plano Comissão). Para planos Essencial e Apoiador não há comissão percentual — aplica-se taxa fixa de <strong className="text-foreground">R$ 1,00 por venda PDV</strong>, incluída na fatura mensal.</p>
          <p>9.3. Taxa PIX (R$ 1,99): cobrada por transação PIX Online <strong className="text-foreground">apenas nos planos Essencial e Apoiador</strong>, descontada automaticamente do valor repassado ao lojista. No plano Comissão, a comissão percentual já cobre os custos operacionais do PIX — não há cobrança adicional de R$ 1,99.</p>
