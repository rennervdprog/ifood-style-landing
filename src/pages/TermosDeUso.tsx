      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6 text-sm text-muted-foreground">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-4 space-y-2">
            ...
            <li><strong className="text-foreground">Crescimento (R$ 50/mês + 2,5%):</strong> 2,5% sobre subtotal delivery (sem taxa PIX adicional). Taxa de entrega: R$ 2,00/pedido. PDV: 1% sobre subtotal presencial (faturado mensalmente). <strong className="text-foreground">Plano dinâmico:</strong> após 2 meses consecutivos com faturamento superior a R$ 5.000, a mensalidade pode ser reajustada para R$ 100/mês, mediante prévia notificação e aceite expresso (vide 5.2).</li>
          ...
          <p>5.2. <strong className="text-foreground">Plano Dinâmico (Essencial e Crescimento):</strong> O faturamento mensal é apurado automaticamente todo dia 1º do mês considerando os pedidos finalizados no mês anterior. O reajuste só ocorre após 2 meses consecutivos acima do limite e <strong className="text-foreground">depende de aceite expresso do Lojista no painel</strong>, com antecedência mínima de 30 dias. O Lojista pode, sem multa, (a) recusar o reajuste e migrar para outro plano disponível, ou (b) rescindir o contrato antes da entrada em vigor. Lojas cadastradas antes de 20/05/2025 mantêm os valores anteriores e não estão sujeitas ao plano dinâmico.</p>
