    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6 text-sm text-muted-foreground">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-4 space-y-2">
            <li><strong className="text-foreground">Essencial (R$ 90/mês):</strong> 0% comissão sobre pedidos delivery. Taxa PIX Online: R$ 1,99/transação (descontada do repasse). Taxa de entrega: R$ 2,00/pedido (paga pelo cliente). PDV: R$ 1,00/venda presencial. <strong className="text-foreground">Plano dinâmico:</strong> após 2 meses consecutivos com faturamento superior a R$ 5.000, a mensalidade pode ser reajustada para R$ 180/mês, mediante prévia notificação e aceite expresso (vide 5.2).</li>
          ...
          <p>5.2. <strong className="text-foreground">Plano Dinâmico (Essencial):</strong> O faturamento mensal é apurado automaticamente todo dia 1º do mês considerando os pedidos finalizados no mês anterior. O reajuste só ocorre após 2 meses consecutivos acima do limite e <strong className="text-foreground">depende de aceite expresso do Lojista no painel</strong>, com antecedência mínima de 30 dias. O Lojista pode, sem multa, (a) recusar o reajuste e migrar para outro plano disponível, ou (b) rescindir o contrato antes da entrada em vigor. Lojas cadastradas antes de 20/05/2025 mantêm os valores anteriores e não estão sujeitas ao plano dinâmico.</p>
          ...
          <p>5.4. O plano Essencial inclui 7 dias de teste grátis. O plano Comissão pode ser utilizado imediatamente.</p>
