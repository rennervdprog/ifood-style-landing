...
const PastelBuilderModal = ({ open, onClose, storeName, storeId, products, sections, priceMode, maxFlavors = 4, singleSize = false, onAdd }: Props) => {
  ...
  const groupedProducts = (() => {
    if (!sections || sections.length === 0) {
      return [{ section: null, items: pastelProducts }];
    }
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-40">
        ...
        {step === 0 && (
          <div className="space-y-3 pt-4">
            <p className="text-sm text-muted-foreground">Escolha quantos sabores diferentes você quer na seu pastel:</p>
...
export default PastelBuilderModal;
