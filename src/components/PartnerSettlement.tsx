      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base flex items-center gap-2">
            <AppIcon name="CalendarCheck" className="w-5 h-5 text-primary" /> Fechamento — Próximo Repasse
          </CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <h4 className="text-sm font-semibold flex items-center gap-2">
            <AppIcon name="TrendingUp" className="w-4 h-4" /> Receitas do Período
          </h4>
        ...
        <div className="space-y-2">
          <h4 className="text-sm font-semibold flex items-center gap-2">
            <AppIcon name="Users" className="w-4 h-4" /> Quanto Cada Sócio Recebe
          </h4>
        ...
        <div className="flex items-center justify-between bg-amber-50 dark:bg-amber-950/30 rounded-lg p-3">
          <div className="flex items-center gap-2">
            <AppIcon name="PiggyBank" className="w-4 h-4 text-amber-600" />
