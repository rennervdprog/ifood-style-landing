...
import {
  ...
  Copy, Filter, Download, Receipt, TrendingDown, TrendingUp, Wallet,
} from "lucide-react";
  ...
  const { data: txs, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select("id, reference_code, amount, status, transaction_kind, created_at, settled_at, pix_copy_paste, provider, metadata")
        .eq("store_id", storeId)
