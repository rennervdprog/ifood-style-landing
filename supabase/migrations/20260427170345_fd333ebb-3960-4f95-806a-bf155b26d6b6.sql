...
-- Update migration version manually since it's an external database being synced
-- We create the table if it doesn't exist to track versioning properly
