-- 1. Função para contar quantas lojas já têm o plano Apoiadores (R$130 fixo)
...
-- 2. Atualizar handle_new_user para suportar selected_plan = 'supporter'
...
BEGIN
  ...
  -- Se escolheu plano "supporter" mas já existem 10 lojas com ele, downgrade para Essencial normal
