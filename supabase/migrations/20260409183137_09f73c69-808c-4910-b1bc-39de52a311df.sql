...
-- Add trial_ends_at to store_plans
ALTER TABLE public.store_plans ADD COLUMN IF NOT EXISTS trial_ends_at timestamptz;
...
-- Update register_as_lojista to also set trial
