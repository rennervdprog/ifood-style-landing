...
BEGIN
  ...
  -- Commission split: only for plans that have commission (hybrid and commission_only)
  ...
  -- Delivery split: only for fixed and hybrid plans (NOT commission_only)
  IF _plan_type IN ('fixed', 'hybrid') THEN
