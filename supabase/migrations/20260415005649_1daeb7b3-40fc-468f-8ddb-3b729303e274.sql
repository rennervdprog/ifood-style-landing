...
ALTER TABLE public.stores ALTER COLUMN delivery_mode SET DEFAULT 'own';

-- 2. Update handle_new_user to always use 'own'
...
-- 3. Update register_as_lojista to always use 'own'
