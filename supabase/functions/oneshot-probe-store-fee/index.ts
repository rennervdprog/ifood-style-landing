...
Deno.serve(async (req) => {
  ...
  out.pastelao = await q(`SELECT id, name, cep, address, delivery_fee_type, delivery_fee_base, delivery_base_km, delivery_fee_per_km, own_delivery_fee FROM public.stores WHERE id='b97f3a1a-d558-41e5-b8a2-ebd65b5381b4';`);
