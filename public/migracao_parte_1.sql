-- Parte 1: Enums e Tabelas Base (Versão com tratamento de erro simplificado)
-- Tente executar cada bloco separadamente se o seu editor não suportar execução em massa com erros.
