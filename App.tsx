...
// 🔄 IMPORTANTE: manter sincronizada com android/app/build.gradle (versionName)
// Quando atualizar essa versão, atualizar também:
//  - android/app/build.gradle: versionCode (incrementar) e versionName
//  - capacitor.config.ts (se houver referência)
